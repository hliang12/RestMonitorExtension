...
public class Config implements Migrator {
	...
	//akana
	protected static final String CONFIG_AKANA_LOGIN_URI = "akanaLoginURI";
	protected static final String CONFIG_GUID = "guid";
	protected static final String CONFIG_TIME_INTERVAL = "intervalData";
	private static final String TIME_INTERVAL_1= "1 Minute";
	private static final String TIME_INTERVAL_5= "5 Minute";
	private static final String TIME_INTERVAL_10= "10 Minute";
	private static final String TIME_INTERVAL_15= "15 Minute";
	...
	Config(MonitorEnvironment env) throws MalformedURLException {
		...
		String akanaLogURI = fixPath(env.getConfigString(CONFIG_AKANA_LOGIN_URI));
		akanaLoginURI = akanaLogURI;

		String tempGuid = env.getConfigString(CONFIG_GUID);
		guid = tempGuid;

		String timeInterval = env.getConfigString(CONFIG_TIME_INTERVAL);
		log.info(CONFIG_TIME_INTERVAL + "  the config time interval");
		log.info(timeInterval + "  into the time interval");
		if(timeInterval.contains("1")) 
			this.timeInterval = 1;
		else if(timeInterval.contains("10"))
			this.timeInterval = 10;
		else if(timeInterval.contains("15"))
